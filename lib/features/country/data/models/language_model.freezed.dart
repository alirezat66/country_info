...
mixin _$LanguageModel {
 ...
 String get code; String get name; String? get native; bool? get rtl;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LanguageModel&&(identical(other.code, code) || other.code == code)&&(identical(other.name, name) || other.name == name)&&(identical(other.native, native) || other.native == native)&&(identical(other.rtl, rtl) || other.rtl == rtl));
}
...
@override
String toString() {
  return 'LanguageModel(code: $code, name: $name, native: $native, rtl: $rtl)';
}
...
@useResult
$Res call({
 String code, String name, String? native, bool? rtl
});
...
/// Create a copy of LanguageModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? code = null,Object? name = null,Object? native = freezed,Object? rtl = freezed,}) {
...
as String?,rtl: freezed == rtl ? _self.rtl : rtl // ignore: cast_nullable_to_non_nullable
as bool?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String code,  String name,  String? native,  bool? rtl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LanguageModel() when $default != null:
return $default(_that.code,_that.name,_that.native,_that.rtl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String code,  String name,  String? native,  bool? rtl)  $default,) {final _that = this;
switch (_that) {
case _LanguageModel():
return $default(_that.code,_that.name,_that.native,_that.rtl);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String code,  String name,  String? native,  bool? rtl)?  $default,) {final _that = this;
switch (_that) {
case _LanguageModel() when $default != null:
return $default(_that.code,_that.name,_that.native,_that.rtl);case _:
  return null;
...
class _LanguageModel extends LanguageModel {
  const _LanguageModel({required this.code, required this.name, this.native, this.rtl}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LanguageModel&&(identical(other.code, code) || other.code == code)&&(identical(other.name, name) || other.name == name)&&(identical(other.native, native) || other.native == native)&&(identical(other.rtl, rtl) || other.rtl == rtl));
}
...
/// Create a copy of LanguageModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? code = null,Object? name = null,Object? native = freezed,Object? rtl = freezed,}) {
